...
class CommerceLab_GreatNews_Block_Rss extends Mage_Rss_Block_Abstract
{
    protected function _toHtml()
    {
        $rssObj = Mage::getModel('rss/rss');

        $data = array('title' => Mage::getStoreConfig('clnews/rss/title'),
            'description' => Mage::getStoreConfig('clnews/rss/description'),
