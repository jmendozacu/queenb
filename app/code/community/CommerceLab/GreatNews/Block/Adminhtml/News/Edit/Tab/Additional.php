...
class CommerceLab_GreatNews_Block_Adminhtml_News_Edit_Tab_Additional extends Mage_Adminhtml_Block_Widget_Form
{
    public function initForm()
    {
        ...
        $fieldset->addField('meta_title', 'text', array(
            'label'     => Mage::helper('clnews')->__('Meta Title'),
            'title' => Mage::helper('clnews')->__('Meta Title'),
            'name'      => 'meta_title',
            'style' => 'width: 520px;',
        ));
        ...
        $fieldset->addField('meta_keywords', 'editor', array(
            'name' => 'meta_keywords',
            'label' => Mage::helper('clnews')->__('Meta Keywords'),
        ...
        $fieldset->addField('meta_description', 'editor', array(
            ...
            'label' => Mage::helper('clnews')->__('Meta Description'),
