...
class CommerceLab_GreatNews_Block_Adminhtml_Comment_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $collection->getSelect()->where('main_table.comment_id =' . $commentId);
        ...
        $fieldset->addField('comment_status', 'select', array(
            ...
            'values'    => array(
                array(
                    'value'     => CommerceLab_GreatNews_Helper_Data::UNAPPROVED_STATUS,
                    'label'     => Mage::helper('clnews')->__('Unapproved'),
                ),

                array(
                    'value'     => CommerceLab_GreatNews_Helper_Data::APPROVED_STATUS,
