...
class CommerceLab_GreatNews_Block_Adminhtml_Comment_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        if ($this->getRequest()->getParam('news_id')) {
            ...
            $collection->getSelect()->joinLeft($tableName, 'main_table.news_id = ' . $tableName . '.news_id', array($tableName . '.title as title', 'main_table.created_time as comment_time'));
        }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('title', array(
            'header'    => Mage::helper('clnews')->__('Newsitem Title'),
            'index'     => 'title',
        ));
        ...
        $this->addColumn('comment_status', array(
            ...
            'type'      => 'options',
            'options'   => array(
                CommerceLab_GreatNews_Helper_Data::UNAPPROVED_STATUS => 'Unapproved',
                CommerceLab_GreatNews_Helper_Data::APPROVED_STATUS => 'Approved',
            ),
        ));
