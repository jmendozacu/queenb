...
class CommerceLab_GreatNews_IndexController extends CommerceLab_GreatNews_Controller_Action
{
    public function indexAction()
    {
        ...
        $this->loadLayout();
        $this->getLayout()->getBlock('root')->setTemplate(Mage::getStoreConfig('clnews/news_display/news_layout'));
        $this->renderLayout();
    }
}
