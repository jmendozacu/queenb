 ...
 */
class Magecheckout_SecuredCheckout_Block_Adminhtml_Totals_Order_View_Tab_Delivery
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        parent::_construct();
        $this->setTemplate('magecheckout/securedcheckout/totals/order/view/tab/delivery.phtml');
    }

    public function getTabLabel()
    {
        return Mage::helper('securedcheckout')->__('Delivery Information');
    }
