...
class Magecheckout_SecuredCheckout_Model_System_Config_Source_Adbandonedcart_Email_Template
{
    ...
    {
        $templates                              = array();
        $templates[self::TEMPLATE_SOURCE_EMAIL] = Mage::helper('securedcheckout')->__('Email Templates');
        ...
        $templates[self::TEMPLATE_SOURCE_NEWSLETTER] = Mage::helper('securedcheckout')->__('Newsletter Templates');
