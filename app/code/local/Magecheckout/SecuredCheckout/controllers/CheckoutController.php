...
class Magecheckout_SecuredCheckout_CheckoutController extends Mage_Checkout_Controller_Action
{
    ...
    public function saveShippingMethodAction()
    {
        ...
        if (!$this->getRequest()->isPost()) {
            ...
            $result['messages'][] = $this->__('Please select shipping method.');
            ...
            if (!empty($saveResult) && isset($saveResult['error'])) {
                $result['success'] = false;
    ...
    {
        return $this->getShippingAddress()->collectTotals()->collectShippingRates();
    }
    ...
    public function savePaymentAction()
    {
        ...
        if (!$data) {
            $errMsg               = $this->__('Please specify payment method.');
     ...
     * Delivery date
     */
    protected function _deliveryDate()
    {
        if ($this->getRequest()->getPost('enabled_delivery_time', false)) {
    ...
    protected function _saveData()
    {
        Mage::getSingleton('checkout/session')->setData('securedcheckout_order_data',
            array(
                ...
                'delivery'                        => $this->getRequest()->getPost('delivery', array()),
                'securedcheckout_survey_answer'   => $this->getRequest()->getPost('securedcheckout_survey_answer', false),
                'securedcheckout_survey_question' => $this->getRequest()->getPost('securedcheckout_survey_question', false),
