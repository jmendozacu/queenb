        ...
        if (is_array($prices)) {
            foreach ($prices as $price) {
                ...
                if ($price['price'] < $productPrice) {
                    ...
                    // correct to 2 x decimals - Stuart Tremain 20150620
                    // $price['savePercent'] = round(100 - ((100 / $productPrice) * $price['price']), 2);
                    
                    // correct to 0 decimals - Stuart Tremain 20150620
                     $price['savePercent'] = round(100 - ((100 / $productPrice) * $price['price']), 0);
                     
                     $price['saveDollars'] = number_format((float) ($productPrice - $price['price']), 2, '.','');
