...
class Mage_Sales_Model_Order extends Mage_Sales_Model_Abstract
{
     ...
     * @throws Exception
     */
    public function sendNewOrderEmail($forAdmin = false)
    {
		if($forAdmin){
		...
		$customer = Mage::getSingleton('customer/session')->getCustomer();
		 $How_find_us_type = $customer->getHow_find_us_type();
		  if( $How_find_us_type == '1'){$How_find_us_type = 'Friend';}
		  if( $How_find_us_type == '2'){$How_find_us_type = 'Media';}
		  if( $How_find_us_type == '3'){$How_find_us_type = 'Search Engine';}
		  if( $How_find_us_type == '4'){$How_find_us_type = 'Retail Store';}
		  if( $How_find_us_type == '5'){$How_find_us_type = 'Social Media';}
		  if( $How_find_us_type == '6'){$How_find_us_type = 'Other';}
        ...
        $mailer->setTemplateParams(array(
			...
			'how_find_us_type'=>$How_find_us_type,
			'how_find_us_value'=> $customer->getHow_find_us_value(),
			'customerLifetimeSales'=>$customerLifetimeSales,
			'customerNumberOfOrders'=>$customerNumberOfOrders,
