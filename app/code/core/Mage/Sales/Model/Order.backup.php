...
class ControllerSaleOrder extends Controller {
	private $error = array();
      ...
      if (isset($this->request->get['filter_order_carrier'])) {
        $url .= '&filter_order_carrier=' . $this->request->get['filter_order_carrier'];
      }
    ...
    if (isset($this->request->get['filter_order_carrier'])) {
      $filter_order_carrier = $this->request->get['filter_order_carrier'];
    } else {
      $filter_order_carrier = null;
    }
    ...
    if (isset($this->request->get['filter_order_carrier'])) {
      ...
      'filter_order_carrier' => $filter_order_carrier,
    ...
    $this->data['column_carrier'] = 'Carrier';
    ...
    $this->data['filter_order_carrier'] = $filter_order_carrier;
    ...
    if (isset($this->request->get['filter_order_carrier'])) {
      $url .= '&filter_order_carrier=' . $this->request->get['filter_order_carrier'];
    	...
    	if (isset($this->request->post['comment_school'])) { //kobe 8/7
      		$this->data['comment_school'] = $this->request->post['comment_school'];
    	} elseif (isset($order_info)) { 
			$this->data['comment_school'] = $order_info['comment_school'];
		} else {
      		$this->data['comment_school'] = '';
    	}	
	...
	public function info() {
      ...
      if (isset($this->request->get['filter_order_carrier'])) {
        $url .= '&filter_order_carrier=' . $this->request->get['filter_order_carrier'];
			...
			$this->data['comment_school'] = nl2br($order_info['comment_school']);//kobe 8/7
			$this->data['shipping_method'] = $order_info['shipping_method'];
			$this->data['payment_method'] = $order_info['payment_method'];
      ...
      // Custom Freight selector start
      $this->load->model('freight/freight');
      $carrier_info = $this->model_freight_freight->getCarrierInfoByOrderId($this->request->get['order_id']);
      $suggested_carrier = $this->model_freight_freight->getSuggestedCarrier($this->request->get['order_id']);

      // as kg
      $this->data['package_weight'] = $carrier_info['package_weight'];
      $this->data['suggested_carrier'] = $suggested_carrier;
      $this->data['current_carrier'] = $order_info['carrier'];
      $this->data['empty_weight_products'] = $carrier_info['empty_weight_products'];
      $this->data['weight_products'] = $carrier_info['weight_products'];

      // Custom Freight selector end
  ...
  public function updateCarrier() {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateDelete()) {
      $this->model_freight_freight->updateCarrierByOrderId($this->request->post['carrier'], $this->request->post['order_id']);
      $status = 'success';
    } else {
      $status = 'fail';
    }
