...
PookCollectInStoreAddress.prototype = {
    ...
    onAddressChanged: function (e) {
        ...
        MagecheckoutSecuredCheckoutCore.updater.startRequest(this.addressChangedUrl, requestOptions);
    },
    ...
    showShippingAddressContainer: function () {
        ...
        var newHeight = MagecheckoutSecuredCheckoutCore.getElementHeight(this.shipping.container);
        this._applyEffect(this.shipping.container, newHeight, 0.3, function () {
            me.shipping.container.setStyle({'height': ''});
            MagecheckoutSecuredCheckoutCore.updateNumbers();
        });
    },
    ...
    showPasswordContainer: function () {
        ...
        var newHeight = MagecheckoutSecuredCheckoutCore.getElementHeight(this.billing.passwordContainer);
    ...
    showNewAddressContainer: function (container) {
        ...
        var newHeight = MagecheckoutSecuredCheckoutCore.getElementHeight(container);
